"""Region/country code generator and mapper for NGL requests."""

from typing import Dict, Optional


class UserRegionGenerator:
    """Handles user region/country code mapping."""
    ...
    def get_country_name(cls, code: str) -> str:
        ...
        Returns:
            Full country name or "Unknown Region" if code not found
        """
        return cls.COUNTRIES.get(code.upper(), "Unknown Region")
    
    @classmethod
    def get_country_code(cls, name: str) -> Optional[str]:
        ...
        """
        for code, country_name in cls.COUNTRIES.items():
